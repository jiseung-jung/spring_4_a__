  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
    	<c:if test="${not empty member}">
    		...
    		<li><a href="${pageContext.request.contextPath}/member/memberPage"><span class="glyphicon glyphicon-log-in"></span> My Page</a></li>
    	</c:if>
      ...
      <li><a href="${pageContext.request.contextPath}/member/memberList.member"><span class="glyphicon glyphicon-user"></span> Member List</a></li>
    </ul>
  </div>
</nav>
